#!/bin/bash
#SBATCH --job-name=dp_sgd_cifar10_scoring_per_group     # Job name
#SBATCH --output=dp_sgd_cifar10_scoring_per_group.out     # Output file
#SBATCH --error=dp_sgd_cifar10_scoring_per_group.err      # Error file
...
python ../mia/scoring_per_group.py \
