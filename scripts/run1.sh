#!/bin/bash
#SBATCH --job-name=dp_sgd_cifar10_1      # Job name
#SBATCH --output=dp_sgd_cifar10_1.out     # Output file
#SBATCH --error=dp_sgd_cifar10_1.err      # Error file
...
export SAVE_DIR="../results1/"  # Replace with your save directory
