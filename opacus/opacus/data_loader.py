...
from opacus.utils.weighted_sampler import WeightedWithReplacementSampler
...
def wrap_collate_with_empty(collate_fn: Optional[_collate_fn_t],
                            sample_empty_shapes: Sequence):
    """
...
class IndividualDPDataLoader(DataLoader):

    def __init__(
            self,
            dataset: Dataset,
            *,
            pp_sample_rates: ndarray,
            num_workers: int = 0,
            collate_fn: Optional[_collate_fn_t] = None,
            pin_memory: bool = False,
            drop_last: bool = False,
        ...
        self.sample_rates = pp_sample_rates
        self.distributed = distributed

        batch_sampler = WeightedWithReplacementSampler(
