#!/bin/bash
#SBATCH --job-name=svhn_A_clipping      # Job name
#SBATCH --output=svhn_A_clipping.out     # Output file
#SBATCH --error=svhn_A_clipping.err      # Error file
...
export epochs=50
# Max Grad Norm
export max_grad_norm=2.0
# Noise Multiplier
export noise_multiplier=2.09719
