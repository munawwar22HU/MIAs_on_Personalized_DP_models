#!/bin/bash
#SBATCH --job-name=dp_sgd_mnist_A_clipping      # Job name
#SBATCH --output=dp_sgd_mnist_A_clipping.out     # Output file
#SBATCH --error=dp_sgd_mnist_A_clipping.err      # Error file
