#!/bin/bash
#SBATCH --job-name=dp_sgd_cifar_B_sampling      # Job name
#SBATCH --output=dp_sgd_cifar_B_sampling.out     # Output file
#SBATCH --error=dp_sgd_cifar_B_sampling.err      # Error file
...
# Noise Multiplier
export noise_multiplier=3.14049
